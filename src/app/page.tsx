    ...
    <main className='bg-white min-h-screen flex flex-col'>
      ...
      <section className='flex-1 max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center'>
        <div className='md:w-1/2 mb-8 md:mb-0 md:mr-8'>
          <h2 className='text-3xl md:text-4xl font-bold text-[#14213D] mb-4'>
            Your Go-To App for Delicious Flavors
          </h2>
          <p className='text-lg text-gray-700 mb-6'>
            Discover, cook, and share amazing recipes anytime, anywhere.
          </p>
          <div>
            <Link
              href='/signup'
        ...
        <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3'>
          <div className='p-6 bg-gray-50 rounded-md text-center shadow-sm'>
            ...
            <p className='text-gray-600 text-sm'>
              Explore hundreds of recipes tailored to your taste.
            </p>
          </div>
          <div className='p-6 bg-gray-50 rounded-md text-center shadow-sm'>
            <Image
            ...
            <p className='text-gray-600 text-sm'>
              Keep track of your meals and maintain a healthy lifestyle.
            </p>
          </div>
          <div className='p-6 bg-gray-50 rounded-md text-center shadow-sm'>
            <Image
            ...
            <p className='text-gray-600 text-sm'>
              Bookmark your top recipes for quick access anytime.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id='about' className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <p className='text-gray-700 mb-4'>
          From a bustling family kitchen in my hometown, I found my passion for
          cooking by learning time-honored recipes passed down through
          generations. Each dish told a story—rooted in culture, tradition, and
          shared memories with loved ones. Over time, I realized that food
          connects us in ways that transcend the dinner table, uniting family
          and friends through cherished flavors and the history behind them.
        </p>
        <p className='text-gray-700 mb-4'>
          Determined to preserve these culinary gems, I created Pocket Taste as
          a digital gathering place where family, friends, and fellow food
          enthusiasts can share the roots of their favorite dishes. This journey
          has also become a testament to my passion for technology and design,
          culminating in a Portfolio Project for{" "}
          <a
          ...
          . By merging tradition and innovation, I hope to inspire others to
          explore the stories behind every recipe and keep culinary heritage
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
          ...
          <div className='bg-white border border-gray-200 rounded-md p-4 shadow-sm'>
            <h5 className='text-lg font-bold text-[#14213D] mb-2'>
              Abubakar Onumoh
            </h5>
        ...
        <div className='mt-6'>
          <h4 className='text-xl font-semibold text-[#14213D] mb-2'>
            Project Repository
          </h4>
